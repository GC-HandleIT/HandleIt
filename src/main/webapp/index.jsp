...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header page-scroll">
			...
			<a class="navbar-brand" href="about.jsp">Who We Are</a>
		</div>
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				<div class="post-preview">
					...
					<h3 class="post-subtitle">We bring non-profit organizations
						and IT professionals together for collaboration on mutually
						beneficial projects</h3>
					<!-- <p class="post-meta">
				...
				<div class="post-preview">
					<h2 style="text-align: center;" class="post-title">Why We Do
						This</h2>
					<h3 class="post-subtitle">As developers, we see a need in the
						...
						by pairing them with skilled professionals.</h3>

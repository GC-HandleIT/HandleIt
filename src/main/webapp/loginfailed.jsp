...
<body>
	...
	<header class="intro-header"
		style="background-image: url('img/loginfail.jpg')">
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				<div class="page-heading">
					<h1 style="text-shadow: 2px 2px 4px #000000">Login Failed</h1>
					<hr class="small">
			...
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				<form action="LoginServlet" method="get">
					<div class="row control-group">
						<p>I'm sorry the email and password you entered was incorrect.</p>

	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				...
				<h4>Co-Founder</h4>
				<p>I started my career in the non-profit arena where skilled IT
					help was limited and often very expensive. Seeing the need it has
					always been in the back of my mind to find ways to bring the two
					things I'm most passionate about to the same table. Technology

	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				...
				<p>One of the challenges that you may face as a new developer is
					gaining experience and building a diversified portfolio. Working
					with non-profit organizations through Handle-IT can help fill in
					the gaps in your resume while also giving back to the community.</p>
